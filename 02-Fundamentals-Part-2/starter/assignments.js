...
const describePopulation = (country, population) => {
  const pow = percentageOfWorld1(population)
  return `${country} has ${population} million people, which is about ${pow}% of the world.`
}

// 3. Call 'describePopulation' with data for 3 countries of your choice
describePopulation(USA.name, USA.population)
describePopulation(India.name, India.population)
describePopulation(Korea.name, Korea.population)
