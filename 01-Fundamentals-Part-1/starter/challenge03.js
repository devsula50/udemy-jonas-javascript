...
evaluateWin(scoreDolphins, scoreKoalas);
...
function evaluateWin(scoreDolphins, scoreKoalas) {
  ...
  if ( scoreDolphins > scoreKoalas ) {
    winTeam = 'Dolphins'
    winScore = scoreDolphins
  } else if ( scoreDolphins < scoreKoalas ) {
    winTeam = 'Koalas'
    winScore = scoreKoalas
  } else {
    winTeam = 'Both'
    winScore = scoreKoalas
  }
  ...
  if ( winScore >= MIN_WIN_SCORE )
    console.log(`${winTeam} win the trophy`)
}